...
\renewcommand{\headrule}{{\answer{\color{.}}\hrule height 0.4pt}}
\renewcommand{\footrule}{{\answer{\color{.}}\hrule height 0.4pt}}
...
\def \ssFix    {\filbreak\subsection*{fix teh brokd codez}}
\def \ssTrace  {\filbreak\subsection*{trace teh werkin codez}}
\def \ssScope  {\filbreak\subsection*{circle teh variablez scope}}
\def \ssMemory {\filbreak\subsection*{fill in da mems}\vspace{2ex}\memory\vspace{3ex}}

\def \lines #1{{\color{.!50}\hrule}#1{\color{.!50}\hrule}}

\def \memory {\lines{\includegraphics{./images/memory-0}}}
...
\def \codeFix #1{%
  \vspace{2ex}
  \question{
    \lines{\inputminted{c++}{./code/#1.cpp}}
  } \answer{
    \lines{\inputminted{c++}{./code/#1.answer.cpp}}
    \lines{\inputminted{diff}{./code/#1.answer.cpp.diff}}
    \lines{\inputminted{text}{./code/#1.answer.cpp.output}}
  }
  \vspace{2ex}
}
...
\def \codeTrace #1{%
  ...
  \question{
    ...
    \lines{\inputminted{text}{./code/#1.cpp.output}}
  }
  \vspace{3ex}
}
...
\ssFix
\codeFix{1-fix-1} \filbreak\vspace{-4ex}
\codeFix{1-fix-2}
